...
.menu > ul > li:hover {
  background: #fff;
    ...
    a.menu:hover .topcategory_names {
      color: #ff6600; /* Change color on hover */
    }


	
    /* Add a hover effect to change the text color to orange */
    .menu ul li a {
    ...
    /* You can also target sub-menus if needed */
    .menu ul li ul li a {
        color: #000; /* Default color for sub-menu */
        transition: color 0.3s ease;
    }

    .menu ul li ul li a:hover {
        color: orange; /* Change sub-menu color to orange on hover */
    }
